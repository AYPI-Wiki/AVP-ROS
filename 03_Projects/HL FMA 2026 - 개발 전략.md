...
- **연산장치**: Jetson(Orin Nano/NX 급 추정). 비전 부하·전력 예산 확인 필요(→ §9 미결정).
...
## 6. 역할 분담 (제안 — 세미나 발표 주제 기반, 확정 필요)

4인([[HL FMA 2026#👥 팀 (4인)]]). 각자 세미나 발표 이력에 맞춘 **제안**이며 팀 합의로 확정.

| 팀원 | 제안 담당 | 근거(세미나) |
|------|-----------|--------------|
| 윤성웅 | 인지 리드(비전·BEV 연구 트랙)·통합 | BEV/Occupancy 발표([[W3_Seminar]] §7) |
| 이준하 | 인지/시스템(서비스·3D 재구성) | ROS2 서비스·SfM+MVS 발표 |
| 육시우 | 계획·제어(경로·PID·Nav) | 경로계획·제어 발표 |
| 최민규 | 인프라·통합(통신·상태머신·로깅) | 기본 명령어·통신 발표 |

> 🔲 실제 역할은 팀 논의로 확정. 주차(④⑦)는 튜닝이 무거워 **2인 페어** 권장.

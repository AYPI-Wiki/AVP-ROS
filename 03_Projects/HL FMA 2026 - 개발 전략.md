...
**🟡 제안됨 (팀 승인 대기)**
- 🟡 **코드 저장소 구조** — **볼트와 별개 리포 + 단일 colcon 모노레포** 권고. → [[HL FMA 2026 - 결정_저장소구조|결정 문서]] (호스팅 계정 등 5건 확인 후 확정).
...
|-----------|------|------|------------------|
| 🟡 **코드 저장소 구조** 확정 (볼트와 별개 개발 리포 여부) | 이준하(인프라) | ~7.14 (⚠️경과) | **→ [[HL FMA 2026 - 결정_저장소구조|결정 문서]] 권고안 도출**(별개 리포+colcon 모노레포). 팀 승인·리포 생성만 남음. |
